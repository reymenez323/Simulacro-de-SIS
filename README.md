...
- MOSFET canal N (IRLZ44N / IRF3205) + resistencias 220 Ω y 10 kΩ + diodo
  1N4007
- Ventilador DC 5-12V con fuente externa
...
Conexionado (ver detalle completo en los comentarios de `src/main.cpp`):
...
GPIO25 --220R-- Gate MOSFET (IRLZ44N / IRF3205)
Gate --10k-- GND (pull-down)
Drain -> terminal (-) del ventilador
Source -> GND común (ESP32 y fuente del ventilador)
